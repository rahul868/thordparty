...
import Flyer from "../reusable/flyer";
      ...
      <div className={styles.rhs_header_content}>
        <div className={styles.document_intro}>
          ...
          <div
            id="mob_file"
            data-mob-lhs-reopen
            className={`${styles.document_intro_svg} ${styles.mobham} ${styles.lhsrepoen}`}
          >
            <svg
          ...
          <div
            id="file_menu"
            className={`${styles.document_intro_svg} ${styles.filepage} ${styles.lhsrepoen}`}
          >
            <svg
              data-lhs-reopen
              xmlns="http://www.w3.org/2000/svg"
